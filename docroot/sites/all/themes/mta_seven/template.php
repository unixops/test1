 ...
 */
function mta_seven_preprocess_maintenance_page(&$vars) {
  // While markup for normal pages is split into page.tpl.php and html.tpl.php,
  // the markup for the maintenance page is all in the single
  // maintenance-page.tpl.php template. So, to have what's done in
  // seven_preprocess_html() also happen on the maintenance page, it has to be
  // called here.
  mta_seven_preprocess_html($vars);
}

/**
 * Override or insert variables into the html template.
 */
function mta_seven_preprocess_html(&$vars) {
 ...
 */
function mta_seven_preprocess_page(&$vars) {
 ...
 */
function mta_seven_node_add_list($variables) {
 ...
 */
function mta_seven_admin_block_content($variables) {
  $content = $variables['content'];
  $output = '';
  if (!empty($content)) {
 ...
 */
function mta_seven_tablesort_indicator($variables) {
 ...
 */
function mta_seven_css_alter(&$css) {
  // Use Seven's vertical tabs style instead of the default one.
  if (isset($css['misc/vertical-tabs.css'])) {
    $css['misc/vertical-tabs.css']['data'] = drupal_get_path('theme', 'even') . '/vertical-tabs.css';
  }
